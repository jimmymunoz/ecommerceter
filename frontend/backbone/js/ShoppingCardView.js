...
App.ShoppingCardView.App = Backbone.View.extend({
	initialize: function() {
		
		var addProductView = new App.ShoppingCardView.AddProduct({ collection: App.products });
		
		var allProductsView = new App.ShoppingCardView.Products({ collection: App.products });
...
|--------------------------------------------------------------------------
*/
App.ShoppingCardView.AddProduct = Backbone.View.extend({
	el: '#addProduct',
...
|--------------------------------------------------------------------------
*/
App.ShoppingCardView.EditProduct = Backbone.View.extend({
...
App.ShoppingCardView.Products = Backbone.View.extend({
	tagName: 'tbody',
	...
	addOne: function(product) {
		var productView = new App.ShoppingCardView.Product({ model: product });
...
|--------------------------------------------------------------------------
*/
App.ShoppingCardView.Product = Backbone.View.extend({
	tagName: 'tr',
	...
	editProduct: function() {
		var editProductView = new App.ShoppingCardView.EditProduct({ model: this.model });
